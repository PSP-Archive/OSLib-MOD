...
float intraFontPrintColumnUCS2Ex(intraFont *font, float x, float y, float width, const unsigned short *text, int length, int autoLineBreak);
...
float intraFontPrintColumn  (intraFont *font, float x, float y, float width, int autoBreakLine, const char *text);
float intraFontPrintColumnEx(intraFont *font, float x, float y, float width, int autoBreakLine, const char *text, int length);
